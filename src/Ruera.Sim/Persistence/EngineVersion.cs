...
public static class EngineVersion
{
    ...
    /// v4 = RUE-31 route templates, v5 = RUE-32 events. RUE-38 (data-driven
    /// scenario + timeline) did not bump: the loaded base:milano-1880 reproduces
    /// the hardcoded trajectory exactly, so golden hashes are unchanged.
    /// </summary>
    public const int SimVersion = 5;
