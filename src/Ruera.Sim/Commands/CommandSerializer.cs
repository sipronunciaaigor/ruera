    ...
    public static CommandLogEntry[] Deserialize(byte[] data)
    {
        ...
        for (var i = 0; i < count; i++)
        {
            ...
            SimCommand command = typeId switch
            {
                ...
                CommandTypeId.AddCarrier => AddCarrierCommand.ReadPayload(reader),
                CommandTypeId.SetCoverage => SetCoverageCommand.ReadPayload(reader),
                CommandTypeId.BuyCarrier => BuyCarrierCommand.ReadPayload(reader),
                ...
                CommandTypeId.SetTemplateCarriers => SetTemplateCarriersCommand.ReadPayload(reader),
